...
public class DAOFirebaseUser {
    ...
    public boolean validateUser(User user, String password) {
        return validateUser(user.emailUser, password, user.firstnameUser, user.lastnameUser);
    }

    public boolean validateUser(final String email, final String password,final String firstName, final String lastName) {
