...
public class EventNearbyActivity extends FragmentActivity implements OnMapReadyCallback,
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        btnRestaurant.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View v) {
                ...
                Toast.makeText(EventNearbyActivity.this,"Nearby Restaurants", Toast.LENGTH_LONG).show();
            }
        });
        ...
        btnHospital.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                GetNearbyEventData getNearbyPlacesData = new GetNearbyEventData();
                getNearbyPlacesData.execute(DataTransfer);
                Toast.makeText(EventNearbyActivity.this,"Nearby Hospitals", Toast.LENGTH_LONG).show();
            }
        });
        ...
        btnSchool.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                GetNearbyEventData getNearbyPlacesData = new GetNearbyEventData();
                getNearbyPlacesData.execute(DataTransfer);
                Toast.makeText(EventNearbyActivity.this,"Nearby Schools", Toast.LENGTH_LONG).show();
            }
        });
    }
    ...
    public void onLocationChanged(Location location) {
        ...
        Toast.makeText(EventNearbyActivity.this,"Your Current Location", Toast.LENGTH_LONG).show();
